...
+ 資料：糖尿病保戶醫療紀錄
```{r}
D = read.csv("C:/Users/Jowett Jhang/Desktop/2019RPB/Group8/unit13/data/quality.csv")  # Read in dataset
summary(D)
```
...
p0 = seq(0.1, 0.9, 0.1); k = 2 #logit->prob.
p1 = sapply(seq(0.1, 0.9, 0.1), pop, k) #p0因勝率效果改變
...
predict(glm1, df, type="response") #response會算出機率
```
...
#機率效果
#OfficeVisits
o=0.11192/(1-0.11192) #o = p/(1-p)
o=exp(0.0821)*o #o = k * o
o/(1+o) #o/(1+o)

#Narcotic
o=0.11192/(1-0.11192) #o = p/(1-p)
o=exp(0.0763)*o #o = k * o
o/(1+o) #o/(1+o)
```
...
```{r}
#勝率是固定的只有機率效果會改變，主要是因為我們需要推算原先的機率，才能推算變數的機率效果，勝率的效果是線性的然而機率的效果並不是線性的。
```
</p class="qiz">
